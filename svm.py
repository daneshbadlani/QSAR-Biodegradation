...
rf_features = ['SpMax_B(m)', 'SpMax_L', 'SM6_B(m)', 'SpPosA_B(p)', 'SpMax_A',                       
                'SdssC', 'SM6_L', 'HyWi_B(m)', 'Psi_i_A', 'F02[C-N]', 'nHM',                             
                'Mi', 'J_Dz(e)', 'nN', 'F03[C-N]', 'TI2_L', 'LOC', 'Me', 
                'n0', 'C%', 'Sd0', 'F04[C-N]', 'F03[C-0]', 'nCb-', 'C-026', 
                'Psi_i_1d', 'NssssC', 'nCp', 'nX', 'nCIR', 'nHDon', 'nArC00R', 
                'NCrt', 'F01[N-N]', 'B03[C-Cl]', 'nArN02', 'B04[C-Br]', 'nN-N', 'N-073',
                'B01[C-Br]', 'nCRX3']          
